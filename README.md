...
rangeAndDpa(path)
```
![1.5 MeV Si in ZrN (1000 nm) Si (500 nm), 16,000 ions calculated](https://github.com/Noah-Miggs/srimpro/tree/main/example_plots/1.5-MeV-Si-in-ZrN-and-Si-io-distribution-and-damage-dose)
